...
class _HtmlViewState extends State<HtmlView> {
  /// Result of [sanitize] for the current content and brightness.
  ///
  /// Parsing the HTML and running the ~10 full-document passes of [sanitize]
  /// over it costs a noticeable amount of time on a slow device, while
  /// build() runs again for all sorts of unrelated reasons (a snackbar, the
  /// drawer opening, an orientation change). flutter_html only looks at the
  /// document again when its dependencies change, so recomputing it on every
  /// build was pure waste.
  htmldom.Document? _document;
  bool _documentIsDarkMode = false;
            ...
            SelectionArea(
              child: Directionality(
                ...
                child: Html.fromDom(
                  ...
                  document: _sanitizedDocument(isDarkMode),
                  extensions: [
